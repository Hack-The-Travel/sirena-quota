...
class TestAmadeus:
    def test_extract_quota(self):
        ticket_quota_response = '''<?xml version="1.0" encoding="UTF-8"?><soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:awsse="http://xml.amadeus.com/2010/06/Session_v3" xmlns:wsa="http://www.w3.org/2005/08/addressing"><soapenv:Header><wsa:To>http://www.w3.org/2005/08/addressing/anonymous</wsa:To><wsa:From><wsa:Address>https://noded1.production.webservices.amadeus.com/1ASIWASIAER</wsa:Address></wsa:From><wsa:Action>http://webservices.amadeus.com/HSFREQ_07_3_1A</wsa:Action><wsa:MessageID>urn:uuid:14b4b4e7-c60d-8d44-39d9-9078af4872b5</wsa:MessageID><wsa:RelatesTo RelationshipType="http://www.w3.org/2005/08/addressing/reply">f0a708f2-ec97-4e7b-9f97-b25655a8f783</wsa:RelatesTo><awsse:Session TransactionStatusCode="End"><awsse:SessionId>01ELYEAUF9</awsse:SessionId><awsse:SequenceNumber>1</awsse:SequenceNumber><awsse:SecurityToken>31F6H6JGQ1C2JZXVAC621NI07</awsse:SecurityToken></awsse:Session></soapenv:Header><soapenv:Body><Command_CrypticReply xmlns="http://xml.amadeus.com/HSFRES_07_3_1A"><longTextString><textStringDetails>/$TICKET QUOTA SYSTEM   CONSOLIDATOR  SIBERIA AIRLINE             
...
S7  SIBERIA AIRLINE       EMDS      50     50       8        42 
        ...
        '''
        tickets, emds = AmadeusQuotaChecker.extract_quota(ticket_quota_response)
        assert tickets == 219
        assert emds == 42
